...
export const DARE_REQUIREMENT_OPTIONS = [
  { id: "camera_photo", label: "Camera/photo" },
  { id: "video_audio", label: "Video/audio" },
  { id: "private_setting", label: "Private setting" },
  { id: "public_semi_public", label: "Public/semi-public setting" },
  { id: "weather_season", label: "Weather/season" },
  { id: "clothing_outfit", label: "Clothing/outfit" },
  { id: "props_items", label: "Props/items" },
  { id: "adult_toy", label: "Adult toy" },
  { id: "partner_helper", label: "Partner/helper" },
  { id: "stranger_service_worker", label: "Stranger/service worker" },
  { id: "online_platform", label: "Online/platform" },
  { id: "vehicle_transport", label: "Vehicle/transport" },
  { id: "duration_timing", label: "Duration/timing" },
  { id: "safety_plan", label: "Safety plan" },
  { id: "airplane", label: "Airplane" },
  { id: "bar_restaurant", label: "Bar/restaurant" },
  { id: "bathroom_restroom", label: "Bathroom/restroom" },
  { id: "bookstore", label: "Bookstore" },
  { id: "car_road_driver", label: "Car/road/driver" },
  { id: "car_wash", label: "Car wash" },
  { id: "changing_room_store_try_on", label: "Changing room/store try-on" },
  { id: "delivery_service_interaction", label: "Delivery/service interaction" },
  { id: "elevator_stairwell", label: "Elevator/stairwell" },
  { id: "home_front_door_window", label: "Home/front door/window" },
  { id: "hotel", label: "Hotel" },
  { id: "kitchen_food_drink", label: "Kitchen/food/drink" },
  { id: "mall_store_shop", label: "Mall/store/shop" },
  { id: "online_video_chat_subreddit", label: "Online/video chat/subreddit" },
  { id: "outdoor_nature", label: "Outdoor/nature" },
  { id: "public_bench", label: "Public bench" },
  { id: "public_transport", label: "Public transport" },
  { id: "roller_coaster_theme_ride", label: "Roller coaster/theme ride" },
  { id: "water_boating", label: "Water/boating" },
  { id: "workplace", label: "Workplace" },
] as const;

export type DareRequirementId = (typeof DARE_REQUIREMENT_OPTIONS)[number]["id"];

const DARE_REQUIREMENT_ID_SET = new Set<string>(
  DARE_REQUIREMENT_OPTIONS.map((requirement) => requirement.id)
);

export function isDareRequirementId(value: string): value is DareRequirementId {
  return DARE_REQUIREMENT_ID_SET.has(value);
}

export const DARE_REQUIREMENTS_BY_SLUG: Record<string, readonly DareRequirementId[]> = {
  "hands-bra": ["camera_photo", "private_setting", "partner_helper"],
  "one-finger-challenge": ["camera_photo", "private_setting"],
  "heartboob": ["camera_photo", "private_setting"],
  "on-off": ["camera_photo", "private_setting", "clothing_outfit"],
  "the-arsenal": ["camera_photo", "private_setting", "props_items", "adult_toy"],
  "good-girl-gone-bad": ["camera_photo", "private_setting", "clothing_outfit", "props_items"],
  "the-music-video": ["video_audio", "private_setting", "clothing_outfit"],
  "the-thunder-tease": ["camera_photo", "video_audio", "weather_season", "home_front_door_window"],
  "human-canvas": ["camera_photo", "private_setting", "props_items"],
  "the-confessional": ["camera_photo", "online_platform"],
  "wilson": ["camera_photo", "private_setting", "props_items", "partner_helper"],
  "ice-queen": ["private_setting", "props_items", "weather_season", "outdoor_nature", "safety_plan"],
  "the-classic-flash": ["public_semi_public", "clothing_outfit", "changing_room_store_try_on", "mall_store_shop"],
  "the-peek-a-boo": ["camera_photo", "private_setting", "props_items"],
  "the-pornstar-pose": ["camera_photo", "private_setting"],
  "window-slut": ["camera_photo", "public_semi_public", "home_front_door_window"],
  "the-online-tease": ["video_audio", "clothing_outfit", "online_platform", "online_video_chat_subreddit"],
  "morning-brew-and-boobs": ["private_setting", "props_items", "kitchen_food_drink"],
  "the-quivering-countdown": ["video_audio", "private_setting", "adult_toy", "duration_timing"],
  "gym-slut": ["camera_photo", "clothing_outfit"],
  "position-master": ["camera_photo", "private_setting", "adult_toy", "partner_helper"],
  "naked-chief": ["private_setting", "props_items", "kitchen_food_drink", "safety_plan"],
  "winnie-the-pooh": ["public_semi_public", "clothing_outfit", "outdoor_nature"],
  "the-mall-commando": ["public_semi_public", "clothing_outfit", "mall_store_shop"],
  "the-self-admirer": ["camera_photo", "props_items", "duration_timing"],
  "the-strip-queen": ["video_audio", "private_setting", "clothing_outfit"],
  "the-slippery-slut": ["camera_photo", "private_setting", "props_items"],
  "the-bikini-challenge": ["video_audio", "private_setting", "clothing_outfit", "adult_toy", "duration_timing"],
  "the-hysterical-literature": ["video_audio", "private_setting", "props_items", "adult_toy"],
  "the-london-bridge": ["private_setting", "adult_toy", "safety_plan"],
  "the-librarian": ["public_semi_public", "clothing_outfit", "bookstore"],
  "the-garden-of-eden": ["camera_photo", "props_items", "outdoor_nature"],
  "the-melting-moment": ["camera_photo", "props_items", "weather_season", "kitchen_food_drink"],
  "the-wax-challenger": ["private_setting", "props_items", "adult_toy", "safety_plan"],
  "the-nip-slip": ["public_semi_public", "clothing_outfit"],
  "the-office-flasher": ["public_semi_public", "clothing_outfit", "workplace"],
  "yoga-outfit": ["public_semi_public", "clothing_outfit", "mall_store_shop"],
  "the-pinup-girl": ["camera_photo", "private_setting"],
  "the-door-dare": ["camera_photo", "home_front_door_window"],
  "the-unexpected-text": ["camera_photo", "online_platform", "stranger_service_worker"],
  "the-see-through-slut": ["clothing_outfit", "public_semi_public"],
  "the-bathroom-exhibitionist": ["public_semi_public", "bathroom_restroom"],
  "the-living-platter": ["private_setting", "props_items", "partner_helper", "kitchen_food_drink"],
  "the-wild-flasher": ["camera_photo", "public_semi_public", "weather_season", "outdoor_nature"],
  "the-anything-but-clothes": ["camera_photo", "private_setting", "clothing_outfit", "props_items"],
  "the-commando-queen": ["public_semi_public", "clothing_outfit"],
  "the-topless-mixologist": ["camera_photo", "video_audio", "private_setting", "props_items", "kitchen_food_drink"],
  "the-store-exhibitionist": ["public_semi_public", "mall_store_shop"],
  "the-sun-worshipper": ["camera_photo", "weather_season", "duration_timing", "props_items"],
  "the-rope-bunny": ["camera_photo", "private_setting", "props_items", "adult_toy", "partner_helper", "safety_plan"],
  "the-dice-slut": ["props_items", "clothing_outfit", "duration_timing"],
  "the-road-flasher": ["public_semi_public", "vehicle_transport", "car_road_driver"],
  "the-cum-target": ["online_platform", "online_video_chat_subreddit"],
  "the-public-cocksucker": ["public_semi_public", "props_items"],
  "the-webcam-hunt": ["video_audio", "online_platform", "online_video_chat_subreddit"],
  "the-strip-gamer": ["video_audio", "online_platform", "online_video_chat_subreddit"],
  "the-bar-flasher": ["public_semi_public", "bar_restaurant"],
  "the-truckers-delight": ["public_semi_public", "vehicle_transport", "stranger_service_worker", "car_road_driver"],
  "the-wet-t-shirt-pro": ["public_semi_public", "clothing_outfit", "props_items", "water_boating"],
  "the-split-screen": ["camera_photo", "video_audio", "public_semi_public"],
  "the-thrill-ride": ["public_semi_public", "roller_coaster_theme_ride"],
  "the-wine-tasting": ["camera_photo", "private_setting", "props_items", "clothing_outfit", "kitchen_food_drink"],
  "the-marilyn-moment": ["public_semi_public", "weather_season", "clothing_outfit", "outdoor_nature"],
  "the-water-nymph": ["camera_photo", "clothing_outfit", "water_boating", "safety_plan"],
  "the-home-exhibition": ["camera_photo", "props_items", "home_front_door_window"],
  "the-shop-flasher": ["public_semi_public", "clothing_outfit", "changing_room_store_try_on", "mall_store_shop"],
  "the-freezer-tease": ["camera_photo", "video_audio", "public_semi_public", "props_items", "mall_store_shop"],
  "the-drive-thru-flasher": ["public_semi_public", "vehicle_transport", "stranger_service_worker", "car_road_driver", "delivery_service_interaction"],
  "the-bathroom-masturbator": ["public_semi_public", "adult_toy", "bathroom_restroom", "safety_plan"],
  "the-topless-light": ["public_semi_public", "props_items", "stranger_service_worker", "delivery_service_interaction"],
  "the-secret-masturbator": ["video_audio", "props_items", "adult_toy", "partner_helper"],
  "the-tourist": ["camera_photo", "public_semi_public", "stranger_service_worker", "delivery_service_interaction"],
  "the-unraveling": ["video_audio", "private_setting", "props_items", "clothing_outfit"],
  "the-full-naturist": ["public_semi_public", "outdoor_nature"],
  "the-remote-slut": ["public_semi_public", "adult_toy", "partner_helper"],
  "the-visible-plug": ["public_semi_public", "adult_toy", "clothing_outfit", "outdoor_nature"],
  "the-bathroom-artist": ["camera_photo", "props_items", "public_semi_public", "bathroom_restroom", "bar_restaurant"],
  "the-see-through-day": ["public_semi_public", "clothing_outfit", "duration_timing"],
  "the-sky-high-flasher": ["public_semi_public", "vehicle_transport", "airplane"],
  "the-frozen-exhibitionist": ["public_semi_public", "weather_season", "outdoor_nature", "safety_plan"],
  "the-mail-run": ["public_semi_public", "clothing_outfit", "outdoor_nature", "home_front_door_window"],
  "the-car-wash-strip": ["public_semi_public", "vehicle_transport", "car_wash", "duration_timing", "clothing_outfit"],
  "the-hotel-exhibitionist": ["public_semi_public", "hotel"],
  "the-bus-masturbator": ["public_semi_public", "vehicle_transport", "public_transport", "adult_toy", "safety_plan"],
  "the-rideshare-flash": ["public_semi_public", "vehicle_transport", "stranger_service_worker", "clothing_outfit", "car_road_driver"],
  "the-gas-pump-flash": ["public_semi_public", "vehicle_transport", "clothing_outfit", "car_road_driver"],
  "the-car-cleaner": ["public_semi_public", "vehicle_transport", "clothing_outfit", "car_wash", "car_road_driver"],
  "the-wet-t-shirt-champion": ["public_semi_public", "weather_season", "clothing_outfit"],
  "the-public-prisoner": ["camera_photo", "public_semi_public", "props_items", "safety_plan", "public_bench"],
  "the-cumwalk": ["public_semi_public", "partner_helper", "outdoor_nature"],
  "the-car-model": ["camera_photo", "public_semi_public", "vehicle_transport", "car_road_driver"],
  "the-naked-sailor": ["public_semi_public", "vehicle_transport", "clothing_outfit", "water_boating", "safety_plan"],
  "laundry-day": ["public_semi_public", "clothing_outfit"],
  "the-public-stripper": ["public_semi_public", "clothing_outfit", "outdoor_nature"],
  "the-secret-rider": ["public_semi_public", "adult_toy", "duration_timing", "public_bench"],
  "the-elevator-stripper": ["camera_photo", "public_semi_public", "clothing_outfit", "duration_timing", "elevator_stairwell"],
  "the-stairway-to-heaven": ["camera_photo", "public_semi_public", "clothing_outfit", "duration_timing", "elevator_stairwell"],
  "the-home-store-shocker": ["public_semi_public", "clothing_outfit", "props_items", "bathroom_restroom", "mall_store_shop"],
  "the-mouthful": ["video_audio", "props_items", "adult_toy", "partner_helper"],
  "full-frontal-freedom": ["public_semi_public", "outdoor_nature"],
  "the-snowblower": ["public_semi_public", "weather_season", "partner_helper", "outdoor_nature", "safety_plan"],
  "the-carwash-cumshot": ["public_semi_public", "vehicle_transport", "partner_helper", "car_wash"],
  "the-naked-driver": ["video_audio", "vehicle_transport", "clothing_outfit", "car_road_driver", "safety_plan"],
  "the-delivery-surprise": ["public_semi_public", "clothing_outfit", "stranger_service_worker", "delivery_service_interaction", "home_front_door_window"],
  "the-stuffed-patron": ["public_semi_public", "adult_toy", "bar_restaurant"],
  "the-cumwalk-2": ["public_semi_public", "partner_helper", "duration_timing"],
  "the-xxx-try-on": ["public_semi_public", "clothing_outfit", "changing_room_store_try_on"],
  "mile-high-service": ["public_semi_public", "vehicle_transport", "partner_helper", "airplane"],
  "the-secret-fuck": ["public_semi_public", "partner_helper", "clothing_outfit", "public_bench"],
  "the-alpha-slut": ["camera_photo", "duration_timing"],
  "the-sky-high-exhibitionist": ["public_semi_public", "vehicle_transport", "airplane"],
  "the-mall-slut": ["public_semi_public", "mall_store_shop"],
};

export function getDareRequirementIds(dare: Pick<PlaybookDare, "slug">): readonly DareRequirementId[] {
  return DARE_REQUIREMENTS_BY_SLUG[dare.slug] ?? [];
}
